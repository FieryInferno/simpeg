...
<body>
  ...
  <div class="text-center">SURAT IZIN CUTI BESAR</div>
  <div class="text-center">NOMOR : <?= $no_surat; ?></div>
  <ol type="1">
    <li>
      <div>Diberikan cuti besar untuk tahun 2021 kepada Pegawai Negeri Sipil :</div>
      <table width="100%">
        <tr>
          <td width="30%">Nama</td>
          <td width="1%">:</td>
      ...
      <ol type="a">
        ...
        <li>Setelah selesai menjalankan cuti besar wajib melaporkan diri kepada atasan langsungnya dan bekerja kembali sebagaimana biasa.</li>
      </ol>
    </li>
    <li>Demikianlah surat izin cuti besar ini dibuat untuk dapat digunakan sebagaimana mestinya.</li>
  </ol>
  <table width="100%">
    <tr>
      <td width="60%">&nbsp;</td>
