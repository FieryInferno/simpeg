...
<body>
  ...
  <div class="text-center">SURAT IZIN CUTI SAKIT</div>
  <div class="text-center">NOMOR : <?= $no_surat; ?></div>
  <ol type="1">
    <li>
      <div>Diberikan cuti sakit kepada Pegawai Negeri Sipil :</div>
      <table width="100%">
        <tr>
          <td width="30%">Nama</td>
          <td width="1%">:</td>
      ...
      <br>
      <p>Selama <?= $pegawai['jumlah_hari']; ?> hari kerja, terhitung mulai tanggal <?= tgl_indo($pegawai['tanggal_mulai']); ?> sampai dengan tanggal <?= tgl_indo($pegawai['tanggal_selesai']); ?> dengan ketentuan setelah berakhir jangka waktu cuti sakit tersebut, wajib melaporkan diri kepada atasan langsungnya dan bekerja kembali sebagaimana biasa.</p>
    </li>
    <li>Demikianlah surat izin cuti sakit ini dibuat untuk dapat digunakan sebagaimana mestinya.</li>
  </ol>
  <table width="100%">
    <tr>
      <td width="60%">&nbsp;</td>
