...
<body>
  ...
  <div class="text-center">SURAT IZIN CUTI TAHUNAN</div>
  <div class="text-center">NOMOR : <?= $no_surat; ?></div>
  <ol type="1">
    <li>
      <div>Diberikan cuti tahunan untuk tahun 2021 kepada Pegawai Negeri Sipil :</div>
      <table width="100%">
        <tr>
          <td width="30%">Nama</td>
          <td width="1%">:</td>
    ...
    <li>Demikianlah surat izin cuti tahunan ini dibuat untuk dapat digunakan sebagaimana mestinya.</li>
  </ol>
  <table width="100%">
    <tr>
      <td width="60%">&nbsp;</td>
