...
<body>
  ...
  <p>dengan ini mengajukan permintaan cuti bersalin untuk persalinan di luar tanggungan Negara untuk persalinan* terhitung mulai tanggal <?= $this->input->post('tanggal_mulai'); ?></p>
