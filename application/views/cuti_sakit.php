...
<body>
  ...
  <p>dengan ini mengajukan permintaan cuti sakit selama <?= $jumlah_hari; ?> hari karena saya <?= $this->input->post('penyebab_sakit'); ?>, sesuai dengan surat keterangan dokter/bidan* terlampir. </p>
