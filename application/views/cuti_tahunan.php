  ...
  <table border="1" width="100%">
    <tr>
      <td width="50%" rowspan="2">
        <div>CATATAN PEJABAT KEPEGAWAIAN</div>
        <div>Cuti yang telah diambil dalam tahun yang bersangkutan: </div>
        <br><br><br>
        <table>
          <tr>
            <td width="80%">1. Cuti Tahunan</td>
            <td width="1%">:</td>
            <td width="19%"></td>
          </tr>
          <tr>
            <td width="80%">2. Cuti Besar</td>
            <td width="1%">:</td>
            <td width="19%"></td>
          </tr>
          <tr>
            <td width="80%">3. Cuti Sakit</td>
            <td width="1%">:</td>
            <td width="19%"></td>
          </tr>
          <tr>
            <td width="80%">4. Cuti Bersalin</td>
            <td width="1%">:</td>
            <td width="19%"></td>
          </tr>
          <tr>
            <td width="80%">5. Cuti Karena Alasan Penting</td>
            <td width="1%">:</td>
            <td width="19%"></td>
          </tr>
        </table>
      ...
      <td width="50%">
        <div>CATATAN/PERTIMBANGAN ATASAN LANGSUNG</div>
      </td>
    </tr>
    <tr>
      <td>
        <div>KEPUTUSAN PEJABAT YANG BERWENANG MEMBERIKAN CUTI</div>
      </td>
    </tr>
  </table>
</body>
