		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<form action="<?php base_url('tata_usaha/update_register/'.$id_register) ?>" method="post">
						...
						<!-- ================= -->
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="no_surat"
								 id="no_surat" aria-describedby="helpId" placeholder="" value="<?= $no_surat;?>">
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" name="tanggal"
								 id="tanggal" aria-describedby="helpId" placeholder="" value="<?= $tanggal;?>">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="perihal"
								 id="perihal" aria-describedby="helpId" placeholder="" value="<?=$perihal;?>">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="pengirim"
								 id="pengirim" aria-describedby="helpId" placeholder="" value="<?=$pengirim;?>">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="tujuan"
								 id="tujuan" aria-describedby="helpId" placeholder="" value="<?=$tujuan;?>">
